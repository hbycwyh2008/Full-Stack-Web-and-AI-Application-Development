...
**Related:** `02_Assessment/Student_Learning_Expectations.md`, `00_Course_Planning/Course_Overview.md`
...
| Term | Definition |
|---|---|
| **Repository (repo)** | A project folder on GitHub that stores files and history |
...
- [ ] Repo name is exactly `cs-learning-log`
...
| 1 | Repo + README with teacher support |
| 2 | Explains README section while looking at repo |
| 3 | Rebuilds README pattern with checklist alone |
...
- Confusing teacher **course repo** with personal `cs-learning-log`
- Wrong repo name or private repo when teacher cannot review
