...
This repository is organized **student-first**. Students begin at [STUDENT_START_HERE.md](STUDENT_START_HERE.md). This page is for teachers and admins.
...
| Assessment | [04_Assessment/](04_Assessment/) | Rubrics, evidence system, AI policy |
| Resources | [05_Resources/](05_Resources/) | AI Literacy, Math Bridge, Git unit |
| Starter code | [06_Starter_Code/](06_Starter_Code/) | Teacher demo + full RAG app |
| Final project | [07_Final_Project/](07_Final_Project/) | Spec, demo plan, Cursor prompt |
| Public docs | [08_Public_Documents/](08_Public_Documents/) | Student/parent overview, posters |
| Teacher planning | [09_Teacher_Planning/](09_Teacher_Planning/) | Daily lesson plans, phase overviews |

**Readiness checklist:** [Course_Implementation_Checklist.md](00_Course_Overview/Course_Implementation_Checklist.md)
...
3. Students follow [Class Missions — Phase 0](02_Class_Missions/Phase_0_Git_GitHub/README.md) in class.
...
**Rubrics:** [04_Assessment/](04_Assessment/)

- [Evidence_System.md](04_Assessment/Evidence_System.md)
- [Assessment_Rubric.md](04_Assessment/Assessment_Rubric.md)
- [Presentation_Rubric.md](04_Assessment/Presentation_Rubric.md)
- [AI_Usage_Policy.md](04_Assessment/AI_Usage_Policy.md)

**Templates:** [03_Templates/](03_Templates/) — students copy into personal repos.

---

## Starter Code and Final Project

**Starter code:** [06_Starter_Code/](06_Starter_Code/)

- `teacher-demo-ai-school-assistant/` — minimal demo for architecture walkthrough
- `ai-school-assistant/` — full RAG reference implementation
