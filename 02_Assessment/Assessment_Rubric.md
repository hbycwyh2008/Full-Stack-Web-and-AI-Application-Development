...
See also: `02_Assessment/Student_Learning_Expectations.md`
...
- Responsible AI Checklist (`00_AI_Literacy/Responsible_AI_Checklist.md`)
- `ai-literacy/` on GitHub

## Phase 3 Evidence (AI Math Bridge)

- `ai-math-bridge/` with README, labs, reflection
- `02_Assessment/AI_Math_Bridge_Checklist.md` complete
