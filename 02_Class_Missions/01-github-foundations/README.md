...
| 7 | [Review and Merge a Pull Request](lesson-07-merge-pull-request.md) | #7 [How to merge a pull request](https://www.youtube.com/watch?v=FDXSgyDGmho) | Review and merge both Lesson 6 pull requests |
...
| 12 | [Markdown on GitHub](lesson-12-markdown.md) | #13 [Getting started with Markdown on GitHub](https://www.youtube.com/watch?v=LxeclcePg-c) | Complete Markdown Skills, then rebuild the formatting in the course repo |
