...
If most students complete the certification sprint in about 45 minutes, use the rest of the 90-minute block as a GitHub evidence audit.

Students should check that they have:

1. Coursera completion, quiz, or certificate evidence.
2. GitHub Skills completion evidence from the GitHub lessons.
...
If students are missing evidence, they should fix the evidence before moving into the next numbered unit.
