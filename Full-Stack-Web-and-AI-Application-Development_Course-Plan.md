# Software Design, Development & AI — Course Plan

## 1. Course Identity

**Course Name:** Software Design, Development & AI  
**Repository:** Full-Stack-Web-and-AI-Application-Development (legacy repository name retained)
...
Students develop practical implementation fluency in:
...
| 05–07 | HCI User Research (OMSCS CS6750 Methods) | needfinding sheet, ask/observe notes, survey + micro need statements |
| 08–11 | Figma Product Design (OMSCS CS6750 Methods) | alternatives → 3 low-fi → eval + further needfinding → high-fi + evaluate again |
