...
Warm-up clips: Google UX *Start the UX Design Process* (short clips only). See teacher map in `09_Teacher_Planning/Daily_Lesson_Plans/shared/classroom-flow-steps-1-3-coursera.md`.
...
- [g7-printables.md](g7-printables.md) — consent script, ask/observe/notes card, bad→good survey examples
