# Lesson 30 — Capstone Implementation Sprint

**Length:** 45 minutes  
**Mission:** Implement the highest-priority capstone work through the normal GitHub workflow while preserving design and requirement traceability.  
...
- data/state needed;
- reusable HTML/CSS/JS patterns already available;
- edge/error states;
...
- implement against approved design/acceptance criteria;
- create coherent commits;
- test as you build;
- use DevTools/debug evidence when behavior differs;
- update the issue if scope changes;
- open/update a PR with implementation and test evidence.
...
Students can implement scoped work through GitHub while explaining the connection among requirement, design, code, testing, and review.
