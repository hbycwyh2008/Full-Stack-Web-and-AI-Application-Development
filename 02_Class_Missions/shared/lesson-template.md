...
Require every student to contribute. The goal is sensemaking, not preparing answers for teacher questioning.
...
- scans for shared misconceptions/bottlenecks;
...
- explain a changed example;
- debug a new case;
- justify a design decision;
- apply the pattern without the group artifact;
...
State 2–4 observable standards showing understanding rather than simple completion.

## Teacher Notes

Pre-plan only likely micro-lessons and common misconceptions. Do not convert the lesson into a teacher-led sequence of questions.
