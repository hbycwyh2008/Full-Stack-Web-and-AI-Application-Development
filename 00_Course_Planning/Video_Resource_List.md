...
## AI Literacy Foundation (Phase 2) — Unified
...
## AI Math Bridge: Linear Algebra for AI (Phase 3)
...
- **How to use:** **Required selected videos** for Phase 3 — not the full playlist for all students.
...
**StatQuest — ML Intro** — supports Phase 3 reuse and ML projects  

> Teacher note: Verify book/Bilibili links before sharing. Optional items do **not** replace Phase 3 required selections.
