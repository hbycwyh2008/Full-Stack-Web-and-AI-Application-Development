...
After watching the official video, students can upload a small, intentionally organized folder and verify the resulting commit.
...
| Role | What |
|---|---|
| **Video** | **Playlist #4** — [How to upload files and folders to GitHub: GitHub for Beginners](https://www.youtube.com/watch?v=tlu5e0TxSzo) |
| **Guided practice** | Upload saved Lesson 1–2 notes, then independently upload a second folder |
| **Practice source** | Teacher-designed github.com rebuild; no close video-aligned GitHub Skills exercise selected |
| **Evidence** | `github-foundations/foundations-notes/` plus `upload-rebuild/README.md` |
| **Exit Ticket** | `learning-log.md` → Lesson 4 |
...
| Term | Meaning |
|---|---|
| **upload** | Add an existing local file through GitHub |
| **folder** | A directory used to organize related files |
...
Watch **playlist #4 only**: [How to upload files and folders to GitHub: GitHub for Beginners](https://www.youtube.com/watch?v=tlu5e0TxSzo).
...
1. Prepare a local folder named `foundations-notes` containing the Lesson 1 and Lesson 2 files.
2. Without replaying the video, upload that folder inside `github-foundations/` on github.com.
3. Use the commit message `Upload Git foundations notes`.
4. Open the resulting commit and verify both files and their full paths.

### 32–40 min: Independent Rebuild

Without replaying the video, upload a second folder named `upload-rebuild` containing an original `README.md`. Verify that the folder structure, file path, commit message, and commit diff are correct.

### 40–45 min: Talk Robin 2 + Evidence

Show the uploaded file at the correct path and the commit that added it.
...
Commit the learning-log update if the lesson's practice did not already require that exact commit. **Homework is only the unfinished Lesson 4 learning-log entry; no video homework.**
...
Lesson 5 continues with the next official playlist video.
