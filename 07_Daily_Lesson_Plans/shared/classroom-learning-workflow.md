...
| Material | Location |
|---|---|
| Phase overview | `04_Lesson_Materials/Phase_X_*.md` |
| Student portfolio guide | `01_Student_Templates/Student_GitHub_Repository_Guide.md` |
| Assessments | `02_Assessment/` |
| Extended Git unit (handouts, rubrics) | `git-github-unit/` |
