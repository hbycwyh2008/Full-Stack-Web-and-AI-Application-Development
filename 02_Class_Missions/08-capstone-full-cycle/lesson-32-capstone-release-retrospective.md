...
- GitHub issues/branches/commits/PRs;
...
`released behavior → code/PR → design → requirement → user evidence`
...
- final QA on deployed version;
- merge approved work;
- deploy/verify production URL;
- create final README with problem, process, setup/use, evidence links, testing, known limitations, and credits/disclosures;
- create release notes/tag if appropriate;
- document maintenance/next-step ideas.
...
1. What was your strongest assumption at the beginning, and what evidence changed it?
2. Which lifecycle stage most improved the final product?
3. What did GitHub make visible about your development process?
...
Students can demonstrate a complete evidence chain from human problem to released software and explain how research, design, coding, testing, and iteration each contributed to the outcome.
