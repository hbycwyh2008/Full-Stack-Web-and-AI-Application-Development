...
- fix high-impact structure/layout issues;
- align visual system;
- verify responsive behavior;
- check keyboard/focus/contrast basics;
...
Students can translate design into working responsive HTML/CSS while documenting and justifying differences rather than treating Figma as a pixel-copy exercise.
